...
[4det Found/Missed](https://github.com/icg-gravwaves/Phase_Time_Amplitude/blob/main/Plotting/Found_missed.ipynb): This takes some outputs of the 4 det search and plots the distributions of found and missed injections. Members of LIGO should be able to run this on the Caltech cluster, otherwise you can request the files and we would be happy to provide as they are too large to include here. This uses the code found in the PyCBC executable pycbc_page_foundmissed so can similarly be generated using this. (https://github.com/gwastro/pycbc/blob/master/bin/plotting/pycbc_page_foundmissed)
